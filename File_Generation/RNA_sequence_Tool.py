...
if __name__ == "__main__":
    if len(argv) != 4:
        print("Usage: python script_name.py <source_file_path1> <source_file_path2> <destination_file_path>")
    source_path_gene = os.path.abspath(argv[1])
    source_path_amino = os.path.abspath(argv[2])
    destination_path = os.path.abspath(argv[3])

    final_dataset = cga.compare(source_path_gene, source_path_amino)
